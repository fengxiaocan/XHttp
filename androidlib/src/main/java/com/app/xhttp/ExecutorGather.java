...
final class ExecutorGather {
     ...
     * @return
     */
    static synchronized ThreadPoolExecutor singleQueue() {
    ...
    static synchronized ThreadPoolExecutor executorDownloadQueue() {
    ...
    static synchronized ThreadPoolExecutor executorHttpQueue() {
        if (newExecutor == null) {
